...
- **Database:** PostgreSQL (Hosted inside a localized Docker Container)
- **Database Client:** VS Code Database Client Extension / DBeaver
- **Data Ingestion (ETL):** Python 3, Pandas, SQLAlchemy, `psycopg2-binary`
- **Language:** SQL (PostgreSQL Dialect)

---

## 📂 Project Structure
1. Business Problem & Analysis.sql   # Comprehensive SQL query file answering 15 questions
2. Create Database.sql               # Database and table schema definitions
3. Download dataset.py               # Python ETL script to ingest CSV data into Postgres
4. netflix_titles.csv                # Raw dataset containing Netflix movies and TV shows
---
## 📊 Database Schema
```sql
